...
const Categories = () => {
    ...
    const createCategory = async () => {
        ...
        setName('')
        setId('')
        return dispatch({ type: 'NOTIFY', payload: { success: res.msg } }, console.log())
    }
                            ...
                            <div key={catogory._id} className="card my-2 text-capitalize">
                                <div className="card-body d-flex justify-content-between">
                                    ...
                                    <div style={{ cursor: 'pointer' }}>
                                        <button className='btn btn-primary' onClick={() => handleEditCategory(catogory)} style={{ marginRight: "5px" }}>Edit</button>
